...
class GuardianCore:
    ...
    def __init__(self) -> None:
        ...
        self.missions: Dict[str, Dict[str, Any]] = {
            m["id"]: {**deepcopy(m), "createdAt": now, "updatedAt": now} for m in INITIAL_MISSIONS
        }
    ...
    def update_mission(self, mission_id: str, patch: Dict[str, Any], *, ledger_state: Optional[str] = None, summary: Optional[str] = None, evidence: Any = None) -> Dict[str, Any]:
        ...
        if next_mission["status"] == "completed":
            if ledger_state != "VERIFIED_COMPLETE" or evidence in (None, "", {}, []):
